    ...
    <div class="layout">
        <header class="page-header">
            <div>
                ...
                <p class="subtitle">Completa los datos principales y la universidad correspondiente.</p>
            </div>
        ...
        <form class="form-card" method="post" action="<?php echo $basePath; ?>estudiante/create">
            <div class="form-grid">
            ...
            <div class="footer-actions">
                <p class="helper">Asegúrate de que la universidad exista antes de guardar.</p>
