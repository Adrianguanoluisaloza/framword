-- Script de inicialización de la base de datos para framword-main
-- Crea tablas mínimas y datos de ejemplo para desarrollo
...
-- NOTA: No insertamos usuario admin con contraseña en texto aquí; usa scripts/create_admin.php o crea un usuario desde la app.

-- Tablas adicionales para estudiantes, universidades y profesores
